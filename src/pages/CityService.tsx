...
const CityService: React.FC = () => {
  ...
  const contentData: Record<string, any> = {
    'edenton-driveways': {
      heroDesc: `Premium concrete driveway installation and replacement for Edenton homeowners. Engineered for the coastal plains soil conditions of northeastern North Carolina.`,
      articleTitle: `Mastering Driveway Construction in Edenton`,
      articleText: `A driveway in Edenton is more than just a place to park; it's a critical component of your property's structural integrity. Near the historic downtown and waterfront areas, the soil requires expert-level stabilization. We utilize a 6-inch compacted ABC stone base and high-density fiber-reinforced concrete to ensure your driveway lasts for decades without the common cracking seen in standard pours.`,
      features: [
        { title: "Coastal Soil Prep", desc: "Deep excavation and engineered stone base for stable coastal plains foundations." },
        { title: "Historic Matching", desc: "Artisan finishes that complement the unique historic aesthetic of Edenton." },
        { title: "Precision Grading", desc: "Laser-leveled slope management to protect your home's foundation from runoff." }
      ],
      reviews: [
        { text: "They replaced our long driveway in Edenton. The crew was professional and the finish is flawless.", author: "Michael R., Edenton, NC" },
        { text: "Best concrete work we've seen in the area. They matched our existing walkway perfectly.", author: "Sarah W., Edenton, NC" }
      ],
      mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d25918.8!2d-76.6076!3d36.0577!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89a4e8c5c3c3c3c3%3A0x89a4e8c5c3c3c3c3!2sEdenton%2C%20NC!5e0!3m2!1sen!2sus!4v1704576000000!5m2!1sen!2sus"
    },
    'currituck-patios': {
      heroDesc: `Luxury artisan stamped patios for Currituck homes. High-end decorative finishes designed for ultimate outdoor living.`,
      articleTitle: `High-Performance Patios for Currituck Living`,
      articleText: `Living in Currituck County demands a higher standard of concrete artistry. Our stamped patios utilize UV-stable pigments and high-solids solvent sealers to prevent the fading and wear common in coastal outdoor projects. Near the Outer Banks and Sound, our weather-resistant technology options keep surfaces comfortable, making your outdoor oasis the centerpiece of your property.`,
      features: [
        { title: "Coastal Grade Tech", desc: "Specialized overlays and textures that stay comfortable and look premium in coastal conditions." },
        { title: "Weather Resistance", desc: "Industrial-grade sealers that protect against salt air and coastal storms." },
        { title: "Artisan Textures", desc: "Custom hand-staining and textures for maximum visual depth and luxury." }
      ],
      reviews: [
        { text: "Our new patio in Currituck is amazing. The detail in the stamping is incredible.", author: "Jennifer L., Currituck, NC" },
        { text: "Professional team. They handled our large-scale project with absolute precision.", author: "Robert P., Currituck, NC" }
      ],
      mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100000!2d-76.0!3d36.3!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89a5000000000000%3A0x0000000000000000!2sCurrituck%2C%20NC!5e0!3m2!1sen!2sus!4v1704576000000!5m2!1sen!2sus"
    }
  };
  ...
  const current = contentData[`${city}-${service}`] || {
    ...
    articleText: `A ${serviceName} project in ${cityName} requires a deep understanding of North Carolina's regional variables. At Elizabeth City Concrete, we provide high-end craftsmanship designed specifically for the ${cityName} environment. Our team utilizes high-density mixes and advanced reinforcement to ensure your project stands the test of time in the Pasquotank County region.`,
    features: [
  ...
  return (
    <div className="overflow-x-hidden bg-white">
      <Helmet>
        ...
        <link rel="canonical" href={`https://elizabethcityncconcretecontractor.com/${city}/${service}`} />
      </Helmet>
              ...
              <div className="bg-black text-white p-6 md:p-12 rounded-[50px] my-16 text-white shadow-2xl shadow-black/20 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 text-lg leading-relaxed mb-8">
                    Our team understands the specific hydraulic and geotechnical variables of the {cityName} region. From managing the coastal plains soil to ensuring perfect water runoff, we are the authority on {serviceName}.
                  </p>
