...
const Home3: React.FC<HomeProps> = ({ cityName = "Elizabeth City" }) => {
  const mapUrl = cityName === "Elizabeth City" 
    ? "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3263.1!2d-80.7128!3d35.1167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8854210909090909%3A0x8854210909090909!2sElizabeth City%2C%20NC!5e0!3m2!1sen!2sus!4v1704576000000!5m2!1sen!2sus"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right" data-aos-duration="1000">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <Link to={cityName === "Elizabeth City" ? "/driveways" : `/${cityName.toLowerCase().replace(" ", "-")}/driveways`} className="bg-white border-2 border-black text-black px-8 py-4 rounded-2xl font-bold text-center hover:border-black transition-all">
                  Our Work
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-xl text-black" data-aos="fade-up" data-aos-delay="100">
              We specialize in high-performance concrete solutions tailored for the unique soil conditions and climate of the North Piedmont.
            </p>
          </div>
          ...
          <div className="space-y-32">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="order-2 md:order-1">
                ...
                <p className="text-black text-lg leading-relaxed mb-6">
                  Our premium concrete driveways are engineered to withstand the expansive clay soils of Pasquotank County. We go beyond industry standards by utilizing a high-density mix reinforced with synthetic fibers, ensuring a 30-50 year lifecycle for your {cityName} home.
                </p>
                ...
                <Link to={cityName === "Elizabeth City" ? "/driveways" : `/${cityName.toLowerCase().replace(" ", "-")}/driveways`} className="font-bold flex items-start group text-black">
              ...
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/driveways/option 2.png" alt="Concrete Driveway Elizabeth City NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/foundations/option 2.jpg" alt="Foundations Elizabeth City NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
                ...
                <p className="text-black text-lg leading-relaxed mb-6">
                  The strength of your building starts with the slab. We provide precision-engineered foundations for custom homes in Currituck and Hertford, utilizing industrial-grade geotechnical preparation to achieve 98% Proctor density.
                </p>
                <p className="text-black text-lg leading-relaxed mb-8">
                  Our foundation services include slab-on-grade, monolithic pours, and specialized underpinning for historic restorations in Downtown {cityName}. We manage all Pasquotank County inspections to ensure your project stays on schedule.
                </p>
                ...
                <Link to={cityName === "Elizabeth City" ? "/foundations" : `/${cityName.toLowerCase().replace(" ", "-")}/foundations`} className="font-bold flex items-start group text-black">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="order-2 md:order-1">
                ...
                <p className="text-black text-lg leading-relaxed mb-6">
                  Elevate your outdoor living with artisan stamped concrete that rivals luxury resorts. Our seamless, reinforced slabs eliminate the weed growth and shifting issues common with traditional pavers in Edenton and Kitty Hawk.
                </p>
                <p className="text-black text-lg leading-relaxed mb-8">
                  Choose from our signature {cityName} collections, including Historic Elizabeth City Slate and Six-Mile Wood Plank, all finished with UV-resistant pigments and high-solids solvent sealers.
                </p>
                <Link to={cityName === "Elizabeth City" ? "/patios" : `/${cityName.toLowerCase().replace(" ", "-")}/patios`} className="font-bold flex items-start group text-black">
                  Design Your Outdoor Oasis <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/patios/option 2.jpg" alt="Stamped Patios Elizabeth City NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/pool-decks/option 2.jpg" alt="Pool Decks Elizabeth City NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
                  <Logo className="text-black w-8 h-8" />
                ...
                <Link to={cityName === "Elizabeth City" ? "/pool-decks" : `/${cityName.toLowerCase().replace(" ", "-")}/pool-decks`} className="font-bold flex items-start group text-black">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="order-2 md:order-1">
                ...
                <p className="text-black text-lg leading-relaxed mb-8">
                  Our process includes professional diamond grinding and MVT-mitigation primers to solve the "sweating slab" issues common in Pasquotank County homes.
                </p>
                <Link to={cityName === "Elizabeth City" ? "/garage-floors" : `/${cityName.toLowerCase().replace(" ", "-")}/garage-floors`} className="font-bold flex items-start group text-black">
                  Upgrade Your Garage <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/garage-floors/option 2.jpg" alt="Garage Floors Elizabeth City NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/sidewalks/option 2.jpg" alt="Sidewalks Elizabeth City NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
                ...
                <Link to={cityName === "Elizabeth City" ? "/sidewalks" : `/${cityName.toLowerCase().replace(" ", "-")}/sidewalks`} className="font-bold flex items-start group text-black">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div data-aos="fade-left">
              ...
              <p className="text-xl text-black mb-6 leading-relaxed">
                Founded on the principles of integrity and technical mastery, Elizabeth City Concrete has grown into Pasquotank County's most trusted partner for high-end residential and commercial builds.
              </p>
      ...
      <section id="testimonials" className="py-32 bg-gray-50 overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-black" data-aos="fade-up" data-aos-delay="100">See why your neighbors in Pasquotank County choose Elizabeth City Concrete.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { text: "Their team handled the foundation for our custom home in Currituck perfectly. The level of communication was outstanding.", author: "Michael S., Elizabeth City, NC" },
              { text: "The new stamped patio they designed for us in Edenton is beautiful. It's completely changed how we use our backyard.", author: "Sarah J., Elizabeth City, NC" },
              { text: "Professional, clean, and fast. They replaced our long driveway in Brightmoor in just three days. Highly recommend.", author: "Robert D., Elizabeth City, NC" },
              { text: "Best concrete contractors in Elizabeth City. They did our garage floor with polyaspartic coating and it looks like a showroom.", author: "James L., Elizabeth City, NC" },
              { text: "Very impressed with their attention to detail on our pool deck. It's slip-resistant and stays cool in the sun.", author: "Emily W., Hertford, NC" },
              { text: "High quality work and very professional crew. They handled all the permitting for our new sidewalk on Trade St.", author: "David K., Downtown Elizabeth City" },
              { text: "We've used them for three different projects now. They are the only concrete team we trust in Pasquotank County.", author: "Linda M., Camden, NC" },
              { text: "The foundation they poured for our addition was perfect. Passed all inspections without a single issue.", author: "Chris P., Kitty Hawk, NC" },
              { text: "Amazing transformation of our old cracked driveway. The new finish with the picture frame border is stunning.", author: "Nancy T., Elizabeth City, NC" },
              { text: "Great experience from start to finish. The quote was transparent and the work was completed on schedule.", author: "Kevin B., Hertford, NC" },
              { text: "Their knowledge of local soil conditions really showed. They took extra steps to ensure our slab won't crack.", author: "Patricia G., Currituck, NC" },
              { text: "Excellent customer service. They took the time to explain all our decorative options for the back patio.", author: "Steven R., Elizabeth City, NC" }
            ].map((t, i) => (
      ...
      <section id="faq" className="py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-black" data-aos="fade-up" data-aos-delay="100">Everything you need to know about our process in Pasquotank County.</p>
          </div>
          <div className="space-y-6">
            {[
              { q: "How long does a standard driveway project take?", a: "Typically, a full driveway replacement in Elizabeth City takes between 3 to 5 days, depending on weather and site preparation requirements." },
              ...
              { q: "Do you handle local permits and inspections?", a: "Yes, we manage all coordination with the Town of Elizabeth City and Pasquotank County building departments, including 811 utility locates and final inspections." },
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            <div data-aos="fade-right">
              <h2 className="text-4xl md:text-5xl font-extrabold mb-8">Serving {cityName} & Pasquotank County</h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                {[
                  { name: 'Downtown Elizabeth City', path: '/' },
                  { name: 'Edenton', path: '/edenton' },
                  { name: 'Hertford', path: '/hertford' },
                  { name: 'Camden', path: '/camden' },
                  { name: 'Kitty Hawk', path: '/kitty-hawk' },
                  { name: 'Currituck', path: '/currituck' },
                ].map((city) => (
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-white">(252) 765-4639</p>
                  </div>
                </div>
                <div className="flex items-start space-x-6">
                  <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-start justify-center">
