          ...
          <div className="flex flex-col min-h-screen font-inter text-black">
            ...
            <main className="flex-grow">
              <Routes>
                ...
                <Route path="/edenton" element={<Home cityName="Edenton" />} />
                <Route path="/hertford" element={<Home cityName="Hertford" />} />
                <Route path="/camden" element={<Home cityName="Camden" />} />
                <Route path="/kitty-hawk" element={<Home cityName="Kitty Hawk" />} />
                <Route path="/currituck" element={<Home cityName="Currituck" />} />
